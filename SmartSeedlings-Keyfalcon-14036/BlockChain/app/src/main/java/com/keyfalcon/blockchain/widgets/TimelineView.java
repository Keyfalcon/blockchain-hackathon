...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if(mMarker == null) {
            mMarker = mContext.getResources().getDrawable(R.drawable.ic_marker_success);
        }
    ...
    /**
     * Sets ic_marker_success.
     *
     * @param marker will set ic_marker_success drawable to timeline
     */
    ...
    /**
     * Sets ic_marker_success size.
     *
     * @param markerSize the ic_marker_success size
     */
